        ...
        List {
            Section {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("The hike wich looks gorgeous in photos but is even better once you actually there. The hike that you hope to do again someday. \nFund the best day hikes in the app.")
                        .font(.footnote)
                        .italic()
